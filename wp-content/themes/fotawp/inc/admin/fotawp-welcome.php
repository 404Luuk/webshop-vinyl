...
?>
            <div class="fotawp-admin-notice notice notice-info updated is-dismissible content-install-plugin theme-info-notice" id="fotawp-dismiss-notice">
                ...
                <div class="info-content">
                    ...
                    <span class="new-features"><?php echo __('5 Additional Homepage Template as ready to import Patterns', 'fotawp'); ?></span>
                    <h2><?php echo __('Congratulations! FotaWP has been installed and ready to build your website!', 'fotawp'); ?></h2>

                    <h3><?php echo __('Get 100% control of your site,', 'fotawp'); ?> <?php echo __('No limit at all! Full Site Editing block builder and Elementor make it happened! Access 130+ ready to import patterns, 5+ homepage patterns and 28+ pre-built demos are avilable for one click demo import, start with importing stater demos?', 'fotawp'); ?>
                    </h3>
